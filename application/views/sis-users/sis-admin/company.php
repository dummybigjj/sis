                ...
                <div class="col-xl-12">
                  <div class="cardbox">
                    <div class="cardbox-heading">
                      <div class="cardbox-header">Company table</div><small> &nbsp&nbsp </small>
                      <div class="cardbox-title">
                        ...
                        <a href="<?php echo site_url('new_company'); ?>" class="mb-4 btn btn-primary"><span class="nav-icon"><em class="ion-ios-plus-outline"></em></span> Add Company</a>
                      </div>
                    </div>
                              ...
                              <?php foreach($company as $value): ?>
                                <tr>
                                  <td>
                                    <div class="form-group mt-0">
                                      <div class="custom-control custom-checkbox mb-0">
                                        <input class="custom-control-input" id="logcheck <?php echo $ctr; ?>" name="company_id[]" value="<?php echo $value['company_id']; ?>" type="checkbox">
                                  ...
                                  <td>
                                    <button type="button" class="mb-4 btn btn-warning" onclick="edit_company(<?php echo $value['company_id'];?>)"><span class="nav-icon"><em class="ion-edit"></em></span> Edit</button>
                                  </td>
                                </tr>
                                <?php $ctr++; ?>
                              <?php endforeach; ?>
